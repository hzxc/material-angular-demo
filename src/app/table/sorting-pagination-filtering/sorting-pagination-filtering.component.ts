...
@Component({
  selector: 'app-sorting-pagination-filtering',
  templateUrl: './sorting-pagination-filtering.component.html',
  styleUrls: ['./sorting-pagination-filtering.component.scss']
})
export class SortingPaginationFilteringComponent implements OnInit {
