...
@Component({
  selector: 'app-e-ngx-print-demo',
  templateUrl: './e-ngx-print-demo.component.html',
  styleUrls: ['./e-ngx-print-demo.component.scss']
})
export class ENgxPrintDemoComponent implements OnInit {
